...
"""
This function will read all the parameter in oci config
"""
...
def run_terrafom():
    ...
    # run terraform apply  on ./
    #terraform_apply = subprocess.getoutput("terraform  apply -auto-approve")


    cmd = ["terraform", "apply", "-auto-approve"]

    process = subprocess.Popen(cmd, bufsize=1,  stdout=subprocess.PIPE, stderr=subprocess.STDOUT)
